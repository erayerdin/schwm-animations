...
export const Logo: React.FC<{
	...
	return (
		<div>
			<svg style={{transform: `translateY(${wave1}px)`}} className="absolute" height={120} viewBox="0 0 51 31">
				<path
			...
			<svg style={{transform: `translateY(${wave2}px)`}} height={120} viewBox="0 0 51 31">
				<path
